...
//
//    public InMemoryDemoExpenseManager(MainActivity mainActivity) {
//        setup(mainActivity);
//    }
//
//    @Override
...
//
//        TransactionDAO DBTransactionDAO = new DBTransactionDAO(mainActivity);
//        setTransactionsDAO(DBTransactionDAO);
//
//        AccountDAO DBAccountDAO = new DBAccountDAO(mainActivity);
